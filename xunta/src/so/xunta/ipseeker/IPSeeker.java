...
import so.xunta.ipseeker.LogFactory;
import so.xunta.localcontext.LocalContext;
  
public class IPSeeker {  
    //纯真IP数据库名  
    private String IP_FILE=LocalContext.IP_FILE;  
    //保存的文件夹  
    private String INSTALL_DIR=LocalContext.INSTALL_DIR;  
    ...
    public static void main(String[] args) {
    	IPSeeker ips=new IPSeeker("QQWry.Dat",LocalContext.IPSeekerLibLocation);
    	String s=ips.getCountry("183.193.2.3");
